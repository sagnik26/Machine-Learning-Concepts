...
For the full flowchart (**`mldlc_flowchart.svg`**) and a stage-by-stage walkthrough, see **[ML development lifecycle](./ml_development-lifecycle)**.
...
| `static/assets/mldlc_flowchart.svg` | End-to-end ML project lifecycle — see [ml_development-lifecycle](./ml_development-lifecycle) |
